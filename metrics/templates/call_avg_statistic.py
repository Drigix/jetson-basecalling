...
plt.title(f'Average basecalling with batch size {args.batch_size} and file size {args.file_size}MB')
...
plt.savefig(os.path.join(output_dir, 'avg_statistic_plot.jpg'), format='jpg')
