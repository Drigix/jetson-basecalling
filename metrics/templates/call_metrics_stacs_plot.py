...
ax.set_title('RAM Usage during basecalling with batch size batch size: {}'.format(args.batch_size))
...
ax.set_title('CPU Usage during basecalling with batch size: {}'.format(args.batch_size))
ax.set_xlabel('Time (s)')
ax.set_ylabel('CPU (%)')
ax.set_ylim(0, 100)
ax.legend()
